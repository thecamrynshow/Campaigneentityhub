...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    number: "04",
    name: "DIBBS Copilot",
    tagline: "A quoting treadmill for DLA medical solicitations",
    domain: "AI / Government Procurement",
    problem:
    ...
    keyDecisions: [
      "Stage-based pipeline — opportunities progress through clear stages with guided next actions, not just a status label",
      "PDF extraction first — structured data from solicitations eliminates the most error-prone manual step",
      "Supplier outreach tools built in — call scripts, draft emails, and a supplier catalog with NSN/part mappings reduce context-switching",
      "DIBBS-ready output — quotes format directly for submission, not as intermediate documents that need rework",
    ],
    impact: [
    ...
    metrics: [
      "Time from solicitation to submitted quote",
      "Opportunities managed per buyer",
      "Quote compliance rate on first submission",
    ...
    flow: [
      { label: "Environment", detail: "DLA solicitations arrive as dense PDFs requiring manual processing" },
      { label: "Friction", detail: "Multi-step quoting across extraction, sourcing, pricing, and compliance" },
      { label: "System", detail: "Guided pipeline: PDF → structured data → supplier outreach → DIBBS-ready quote" },
      { label: "Outcome", detail: "More quotes submitted faster with fewer errors and less context-switching" },
    ],
  },
  {
    id: "pilotengine",
...
export const productIndex: ProductIndexItem[] = [
  ...
  },
  {
    name: "DIBBS Copilot",
    type: "Workflow Tool",
    domain: "AI / Gov Procurement",
    description: "Solicitation-to-quote pipeline for DLA medical procurement",
    status: "Shipped",
  },
  {
    name: "PilotEngine",
