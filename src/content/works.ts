...
export const works: Work[] = [
  ...
  {
    id: "architecture-of-alignment",
    slug: "the-architecture-of-alignment",
    title: "The Architecture of Alignment",
    type: "book",
    status: "released",
    shortDescription: "How the words of Jesus reveal the laws of human behavior, endurance, and lasting power.",
    longDescription: "The Architecture of Alignment examines the words attributed to Jesus not as religious doctrine, but as precise constraints on reality—principles that reliably reduce failure across the brain, the body, organizations, and time. Written for builders, leaders, and thinkers carrying real responsibility.",
    theme: {
      bg: "#1A1A2E",
      fg: "#FFFFFF",
      accent: "#D4AF37",
  ...
  },
  {
    ...
    type: "app",
    status: "released",
    shortDescription: "Breathe. Ground. Be Present. Guided breathing and wellness for iPhone and iPad.",
    longDescription: "PNEU is a health and fitness app that helps you breathe through stress, anxiety, and big emotions with guided exercises. Features haptic breathing synced to 65 BPM, voice guidance, and tools for grounding and mindful movement.",
    theme: {
      bg: "#0F3460",
      fg: "#FFFFFF",
      accent: "#D4AF37",
    ...
    datePublished: "2025-01-01",
    identifiers: {
      appStoreUrl: "https://apps.apple.com/us/app/pneu/id6757112120",
    },
  },
  {
    id: "sovereignty",
    ...
    type: "app",
    status: "released",
    shortDescription: "Build Your Dynasty. Nation-building strategy game from Stone Age to the future.",
    longDescription: "SOVEREIGNTY is a strategy game where you guide a civilization through the ages. Build your domain, command your military, forge alliances, and advance through seven historical eras. Balance treasury, resources, and citizen happiness.",
    theme: {
      bg: "#1A1A1A",
      fg: "#FFFFFF",
      accent: "#D4AF37",
