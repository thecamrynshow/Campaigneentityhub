...
export const metadata: Metadata = {
  ...
  description:
    "Campaigne - Official entity hub for Camryn Jackson (Campaigne). Discover books, music, apps, and creative works.",
  ...
  openGraph: {
    ...
    url: `${siteUrl}/campaigne`,
  },
  alternates: {
    canonical: `${siteUrl}/campaigne`,
  },
};

export default function CampaignePage() {
