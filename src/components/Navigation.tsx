        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-brand-gold hover:text-brand-gold/80 focus:outline-none focus:ring-2 focus:ring-brand-gold rounded-md p-2 transition-all duration-300 border border-brand-gold/30 hover:border-brand-gold/60 hover:bg-brand-gold/10"
              aria-label="Menu"
