...
export default function WorkCard({ work, className }: WorkCardProps) {
  ...
  return (
    <Link
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = `0 0 40px ${work.theme.accent}40, 0 8px 16px rgba(0, 0, 0, 0.4)`;
    ...
    >
      <div className="aspect-square relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 transform transition-transform duration-500 group-hover:translate-y-[-4px]">
          <div className="mb-2">
            <span
              className="inline-block px-3 py-1 text-xs font-semibold rounded-full backdrop-blur-sm border"
              style={{
